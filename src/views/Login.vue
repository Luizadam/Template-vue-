<template>
  <div class="row position-relative mt-4" style="z-index: 1;">
    <div class="col-12 col-md-6 d-none d-md-block logo-section">
      <img src="img/brand/logo-default.png" alt class="img-fluid" width="100%" />
    </div>
    <div class="col-12 col-md-6">
      <div class="register-section">
        ...
        <div class="border-0 bg-transparent mt-5">
          <div class="bg-transparent pb-2 d-block d-md-none">
            ...
            <div class="text-muted text-center mt-2 mb-3">
              <img src="img/brand/logo-default.png" alt="Logo Mindzzle" style="width:100%" />
            </div>
          </div>
          <div class>
